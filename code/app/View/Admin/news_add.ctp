		...
		<div class="col-xs-12">
			<form class="form-horizontal"  method="post" action="" enctype="multipart/form-data" id="myform" >
				...
				<div class="form-group" style="height:20px;">
					...
					<span class="">
						<input type="text"  name='news_title' style="width:286px;height:30px;" id="name"
							/>
					</span>
                ...
                <div class="form-group" style="height:20px;">
                    ...
                    <span class="">
                            <input type="text"  name='news_author' style="width:286px;height:30px;"
                                   id="author" />
                    </span>
                ...
                <div class="space-8"></div>
                               ...
                               <div class="form-group" style="height:20px;">
                                    ...
                                    <span class="input-icon">
                                        <div class="radio">
                                           <label>
                                                   <input name="channel_type" value="1" type="radio" class="ace"  checked>
                                                   <span class="lbl">中文</span>
                                           </label>

                                          <label>
                                                  <input name="channel_type" value="2" type="radio" class="ace" >
                          ...
                          <div class="space-8"></div>
                           ...
                           <div class="form-group" style="height:20px;">
                                ...
                                <span class="input-icon">
                                    <div class="radio">
                                               <label>
                                                <input type="radio" name="show" value="1"  class="ace" >
                                                       <span class="lbl">显示</span>
                                               </label>

                                               <label>
                                                       <input type="radio" name="show" value="0" class="ace" checked>
                                                       <span class="lbl">不显示</span>
                                               </label>
                                       </div>
                                </span>
