...
<div style="margin:0;">
    ...
    <div style="margin-top:10px; margin-bottom:3px; height:30px;">
        <span style="float:right;margin-bottom:5px;">
          <a href="Video_add"><button type="button" class="btn spinner-up btn-xs btn-success btn-height">
    ...
    <div class="dataTables_wrapper form-inline" id="sample-table-1_wrapper">
        <table class="table table-striped table-bordered table-hover" style="text-layout:fixed;">
            ...
            <tr class="odd" role="row">
                ...
                <td class="center">
                    <?php echo $v['Video']['video_title']; ?>
                </td>
                <td class="center">
                   <img src="<?php echo $v['Video']['video_pic'];?>" height="100px">
                </td>
                <td class="center">
                    <?php echo $v['Video']['video_url']; ?>
                </td>
                <td class="center">
                    <?php echo date('Y-m-d',$v['Video']['video_time']); ?>
                </td>

                <td class="center">
                    <div class="hidden-sm hidden-xs btn-group">

                        <a href="/admin/video_add?id=<?php echo $v['Video']['id']?>&bk=<?php echo urlencode($_SERVER['REQUEST_URI']);?>" class="" title="编辑">
                            <i class="ace-icon fa fa-edit bigger-130 "></i>
                        </a>&nbsp;&nbsp;&nbsp;

                        <a class="red" role="button" title="删除" onClick="delconfirm('<?php echo $v['Video']['id'];?>')" href="javascript:void(0);">
...
function delconfirm(id) {
  if(window.confirm('您确定要执行删除操作吗？')) {
    window.location.href="/admin/Video_delete?id="+id;
  } else {
